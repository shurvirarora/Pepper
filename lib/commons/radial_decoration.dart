...
class RadialDecoration extends StatefulWidget {
  ...
  const RadialDecoration(
      {Key key,
      @required this.child,
      this.goalCompleted = 1.0,
      this.progressColor = primaryColor,
      this.progressBackgroundColor = primaryColor,
      this.width = 5})
      : super(key: key);

  @override
  _RadialDecorationState createState() => _RadialDecorationState();
}

class _RadialDecorationState extends State<RadialDecoration>
